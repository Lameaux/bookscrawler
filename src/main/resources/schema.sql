...
('adventure', 'Приключения: прочее', 0),
...
('children', 'Детская литература: прочее', 0),
...
('comp-www', 'Интернет', 0),
('design', 'Искусство и Дизайн', 0),
('detective', 'Детективы: прочее', 0),
('det-action', 'Боевик', 0),
...
('drama', 'Драма', 0),
('dramaturgy', 'Драматургия: прочее', 0),
...
('music', 'Музыка', 0),
('mystery', 'Мистерия', 0),
('nonfiction', 'Документальная литература', 0),
...
('reference', 'Справочная литература', 0),
('ref-dict', 'Словари', 0),
('ref-encyc', 'Энциклопедии', 0),
('ref-guide', 'Руководства', 0),
('ref-ref', 'Справочники', 0),
('religion', 'Религиозная литература: прочее', 0),
...
('science', 'Научная литература: прочее', 0),
